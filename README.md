...
A context-aware conversational assistant built using AWS Bedrock to explore multi-turn interactions, streaming responses, and structured LLM outputs.

This project focuses on understanding how to orchestrate LLMs in real applications, rather than just building a basic chatbot.
...
It maintains context across turns and responds intelligently based on prior conversation.
...
LLM-only logic works for prototypes but needs hybrid approaches for production
⚠️ Limitations
...
This project was built as part of learning AWS Bedrock and exploring how to move from:
